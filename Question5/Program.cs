namespace Question5
{
    ...
    public class Student
    {
        ...
        IsEligibleScholarship IsEligibleScholarship { get; set; }
        public static string GetEligibleStudents(List<Student> studentsList,IsEligibleScholarship isEligible)
        {
            string result = "";
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            IsEligibleScholarship del = new IsEligibleScholarship(ScholarshipEligibility);
